// script.js - النسخة النهائية الكاملة مع إصلاح Index والتعليقات
import { 
    auth, 
    db,
...
async function showStoryDetail(storyId) {
    try {
        ...
        // تحميل التعليقات (باستخدام الدالة المعدلة)
...
// ==================== نظام التعليقات المعدل (بدون Index) ====================

// تحميل التعليقات الآمن (بدون مشكلة Index)
...
window.loadCommentsSafe = loadCommentsSafe;